...
/// @file
/// @brief Adaptive Autosar Crypto Stack. Common API. Memory Region types definition.
...
namespace crypto
{
/// @traceid{SWS_CRYPT_10031}@tracestatus{draft}
...
/// @traceid{SWS_CRYPT_10033}@tracestatus{draft}
/// @uptrace{RS_CRYPTO_02004}
...
#endif // ARA_CRYPTO_COMMON_MEM_REGION_H_
