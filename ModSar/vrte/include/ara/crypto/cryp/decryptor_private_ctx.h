...
/// @file
/// @brief Adaptive Autosar Crypto Stack. Cryptographic API. DecryptorPrivateCtx interface definition.
...
///
/// @traceid{SWS_CRYPT_20800}@tracestatus{draft}
...
public:
    ...
    /// @traceid{SWS_CRYPT_20811}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02202}
    ...
    /// @traceid{SWS_CRYPT_20812}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02202}
    ...
    /// @traceid{SWS_CRYPT_20813}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02202}
    /// @brief Process (encrypt / decrypt) an input block according to the cryptor configuration.
