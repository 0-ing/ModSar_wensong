...
/// @file
/// @brief Adaptive Autosar Crypto Stack. Cryptographic API. MsgRecoveryPublicCtx interface definition.
...
///
/// @traceid{SWS_CRYPT_22200}@tracestatus{draft}
...
public:
    ...
    /// @traceid{SWS_CRYPT_22212}@tracestatus{draft}
    ...
    /// @traceid{SWS_CRYPT_22213}@tracestatus{draft}
    ...
    /// @traceid{SWS_CRYPT_22214}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02309}
    ...
    /// @traceid{SWS_CRYPT_22215}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02204}
    ...
    virtual ara::core::Result<ara::core::Vector<ara::core::Byte>> DecodeAndVerify(ReadOnlyMemRegion in
    ) const noexcept = 0;

    /// @traceid{SWS_CRYPT_22216}@tracestatus{draft}
    /// @uptrace{RS_CRYPTO_02204}
    /// @brief Process (encrypt / decrypt) an input block according to the cryptor configuration.
...
//    ara::core::Result<ByteVector<Alloc>> DecodeAndVerify( ReadOnlyMemRegion in
//    ) const noexcept
//    {
