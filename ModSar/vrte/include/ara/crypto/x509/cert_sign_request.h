...
//    /// @error CryptoErrorDomain::kInsufficientCapacity  if <tt>(password != nullptr)</tt>, but its capacity
...
//    ) const noexcept  = 0;
    ...
    /// @error CryptoErrorDomain::kInvalidUsageOrder  this error will be returned in case not all required
