...
public:
    ...
    /// @returns String of the whole DN string
    /// @error  CryptoErrorDomain::kInsufficientCapacity  if <tt>(dn != nullptr)</tt>, but @c dn->capacity()
    ...
    ///             [Error]: CryptoErrorDomain::kUnexpectedValue  if the @c dn string has incorrect syntax
    ...
    /// @error  CryptoErrorDomain::kUnknownIdentifier  if the @c id argument has unsupported value
    /// @error  CryptoErrorDomain::kInsufficientCapacity  if <tt>(attribute != nullptr)</tt>,
    ...
    /// @error  CryptoErrorDomain::kUnknownIdentifier  if the @c id argument has unsupported value
    /// @error  CryptoErrorDomain::kUnexpectedValue  if the attribute string contains incorrect characters
    ...
    /// @error  CryptoErrorDomain::kAboveBoundary if <tt>((id == kOrgUnit) || (id == kDomainComponent))</tt>
