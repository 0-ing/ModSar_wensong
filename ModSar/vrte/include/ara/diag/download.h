...
// --------------------------------------------------------------------------
#ifndef ARA_DIAG_DOWNLOAD_H_INCLUDED
#define ARA_DIAG_DOWNLOAD_H_INCLUDED
...
public:
    ...
    * @uptrace{RS_Diag_04196}
    */
   explicit DownloadService( const ara::core::InstanceSpecifier& specifier, ReentrancyType reentrancyType = ara::diag::ReentrancyType::kNot );
    ...
    * @returns a Future, which either gets readied to void (for a positive response message) or readied with ErrorCode from DiagUdsNrcErrc (for an negative response message)
    ...
    *
    * @param transferRequestParameterRecord data to be transferred (copied/downloaded to the ECU/server).
    * @param metaInfo contains additional meta information
    * @param cancellationHandler informs if the current conversation is canceled
    ...
    * @uptrace{RS_Diag_04196}
    */
   virtual ara::core::Future<OperationOutput> DownloadData( ara::core::Span<std::uint8_t> transferRequestParameterRecord,
                                                            MetaInfo&                     metaInfo,
                                                            CancellationHandler           cancellationHandler ) = 0;
    ...
    * @error Any applicable NegativeResponseValue according to DiagUdsNrcErrc
    *
    ...
    * @uptrace{RS_Diag_04196}
    */
   virtual ara::core::Future<OperationOutput> RequestDownloadExit( ara::core::Span<std::uint8_t> transferRequestParameterRecord,
                                                                   MetaInfo&                     metaInfo,
                                                                   CancellationHandler           cancellationHandler ) = 0;
...
#endif //ARA_DIAG_DOWNLOAD_H_INCLUDED
