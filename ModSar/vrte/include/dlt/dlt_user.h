...
typedef struct
{
    ...
    int8_t block_mode; /**< BlockMode setting of library */
    int8_t force_blocking; /**< If set, BlockMode not changed on Daemon request */
 ...
 * @param mode socket Blocking or Non-blocking mode
 * @return Value from DltReturnValue enum
 */
DltReturnValue dlt_set_socket_mode(DltUserSocketMode mode);
