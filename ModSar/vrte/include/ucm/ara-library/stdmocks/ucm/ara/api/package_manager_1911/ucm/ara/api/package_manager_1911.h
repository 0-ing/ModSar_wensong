...
///
class PackageManager1911 : public ::ara::ucm::pkgmgr::skeleton::PackageManagementSkeleton,
...
public:
    ...
    explicit PackageManager1911(std::unique_ptr<PackageManagerAra> &&pkgmgr)
            :
            ::ara::ucm::pkgmgr::skeleton::PackageManagementSkeleton(
                    ::ara::com::InstanceIdentifier(ara_instance_id)), pkgmgr_(
                    std::move(pkgmgr))
    {
        pop<void>();
    }

    //explicit PackageManager1911(){}
    /// Copy Semantics
    ...
    /// Virtual destructor
    virtual ~PackageManager1911() = default;
    ...
    TransferStart(const uint64_t) override
    {
       return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputTransferStart>>();
    ...
    TransferData(const TransferIdType, const ByteVectorType,
                 const uint64_t) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputTransferData>>();
    }
    ...
    TransferExit(const TransferIdType) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputTransferExit>>();
    }
    ...
    ProcessSwPackage(const TransferIdType) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputProcessSwPackage>>();
    }

    /// \brief Get the id of the UCM subordinate.
    /// \return Id of the UCM subordinate
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputGetId> GetId()
    override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputGetId>>();
    }

    /// \brief Activates the processed components.
    /// \return Error state
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputActivate> Activate()
    override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputActivate>>();
    }
    ...
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputFinish> Finish()
    override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputFinish>>();
    }

    /// \brief Aborts an ongoing processing of a Software Package.
    /// \return Error state
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputCancel> Cancel(
            const TransferIdType) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputCancel>>();
    }

    /// \brief Rollback the system to the state before the packages were processed.
    /// \return Error state
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputRollback> Rollback()
    override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputRollback>>();
    }
    ...
    override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputGetSwClusterChangeInfo>>();
    }
    ...
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputGetSwClusterInfo>>();
    }
    ...
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputGetSwPackages>>();;
    }

    /// \brief Revert the changes done by processing (ProcessSwPackage)
    /// of one or several software packages.
    virtual ::ara::core::Future<::ara::ucm::pkgmgr::OutputRevertProcessedSwPackages>
    RevertProcessedSwPackages() override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputRevertProcessedSwPackages>>();
    }
    ...
    DeleteTransfer(const TransferIdType) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputDeleteTransfer>>();
    }
    ...
    GetSwProcessProgress(const TransferIdType) override
    {
        return pop<::ara::core::Future<::ara::ucm::pkgmgr::OutputGetSwProcessProgress>>();
    }
