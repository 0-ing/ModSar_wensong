...
#ifndef UCM_AAP_IPC__EXM_UCM_IPC__EXM_MQCONF__H_
#define UCM_AAP_IPC__EXM_UCM_IPC__EXM_MQCONF__H_
...
#define UCM_MQIPC_SERVER_NAME "/ucm-ipc-exm-server"

/// @brief Client mqueue file system name template
#define UCM_MQIPC_CLIENT_NAME "/ucm-ipc-exm-client"
...
#endif // UCM_AAP_IPC__EXM_UCM_IPC__EXM_MQCONF__H_
