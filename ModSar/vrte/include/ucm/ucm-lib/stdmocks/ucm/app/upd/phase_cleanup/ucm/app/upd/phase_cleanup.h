...
/// @file         tests/VRTE_UT/stdmocs/ucm/app/upd/phase_cleanup/ucm/app/upd/phase_cleanup.h
/// @brief
...
class PhaseCleanup final
    : public lib::upd::Phase
    , virtual protected ucm::mock::Sequence
{
public:
    explicit PhaseCleanup(lib::upd::UpdateContext& ctx)
        : lib::upd::Phase("cleanup", ctx)
    {}
