...
/// @file         tests/VRTE_UT/stdmocs/ucm/app/upd/phase_erase/ucm/app/upd/phase_erase.h
/// @brief
...
class PhaseErase final
    : public lib::upd::Phase
    , virtual protected ucm::mock::Sequence
{
public:
    explicit PhaseErase(lib::upd::UpdateContext& ctx)
        : lib::upd::Phase("erase", ctx)
    {}
