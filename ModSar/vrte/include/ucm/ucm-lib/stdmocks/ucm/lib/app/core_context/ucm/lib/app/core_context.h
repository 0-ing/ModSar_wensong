...
/// @file         tests/VRTE_UT/stdmocks/ucm/lib/app/core_context/ucm/lib/app/core_context.h
/// @brief
...
class CoreContext final : virtual protected ucm::mock::Sequence
{
    static std::unique_ptr<CoreContext>& instance() noexcept
    {
    ...
    explicit CoreContext(int argc, char** argv) noexcept
        ...
        , sec_service_{}
        , sec_provider_{}
        , ppl_service_{sys_service_}
        , arc_service_{}
        , sdb_service_{}
        , swc_service_{}
        , mnf_service_{}
        , swp_service_{sec_provider_}
        , upd_service_{}
    {}
...
public:
    ...
    {
        instance().reset(new CoreContext(argc, argv));
        return *instance();
    }
