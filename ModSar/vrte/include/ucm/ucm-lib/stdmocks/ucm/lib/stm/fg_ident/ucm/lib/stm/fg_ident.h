...
public:
    ...
    FG_Ident& operator=(FG_Ident     &&) noexcept(move_assignable) = default;
    FG_Ident& operator=(FG_Ident const&) noexcept(copy_assignable) = default;
...
inline std::ostream& operator<<(std::ostream& os, const FG_Ident&) noexcept
{
    return os;
}
