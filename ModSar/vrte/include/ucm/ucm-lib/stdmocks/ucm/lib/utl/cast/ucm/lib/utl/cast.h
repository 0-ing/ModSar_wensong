...
namespace cast_impl {
    ...
    struct Has
    {
        ...
        {
            return ucm::mock::Sequence::pop<To>();
        }
    };
    ...
    {
        using type = To;
        static constexpr type value(Fr&& )
        {
            return ucm::mock::Sequence::pop<To>();
        }
    };
    ...
    struct Not <To, Fr, std::uintptr_t, F*, A>
    {
        ...
        static constexpr type value (Fr&& ) noexcept
        {
            return ucm::mock::Sequence::pop<std::uintptr_t>();
        }
    };
    ...
    struct Not <To, Fr, void*, F*, A>
    {
        ...
        static constexpr type value (Fr&& ) noexcept
        {
            return ucm::mock::Sequence::pop<void*>();
        }
    };
