...
#endif
public:
    explicit ArtifactInstallConfiguration(std::string&& installer_input_value)
        : installer_input_value_(std::move(installer_input_value))
    {}
