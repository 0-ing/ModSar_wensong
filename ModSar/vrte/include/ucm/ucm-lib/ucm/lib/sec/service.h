...
{
#if defined(GOOGLE_TEST)
    FRIEND_TEST(Test__ucm_lib_sec__Service, CTor);
    FRIEND_TEST(Test__ucm_lib_sec__Service, ProxySet);
    FRIEND_TEST(Test__ucm_lib_sec__Service, AppAction);
    FRIEND_TEST(Test__ucm_lib_sec__Service, SetupNolock);
    FRIEND_TEST(Test__ucm_lib_sec__Service, StartoffNolock);
    FRIEND_TEST(Test__ucm_lib_sec__Service, ShutdownNolock);
#endif
...
#endif    // UCM_AAP_LIBRARY__UCM_LIB_SEC__SERVICE_H_
