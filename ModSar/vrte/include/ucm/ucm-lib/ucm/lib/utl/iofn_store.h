...
public:
    ...
    static ssize_t read(int fildes, void* buf, size_t nbyte) noexcept;
    static ssize_t write(int fildes, const void* buf, size_t nbyte) noexcept;
    static int close(int fildes) noexcept;
};
