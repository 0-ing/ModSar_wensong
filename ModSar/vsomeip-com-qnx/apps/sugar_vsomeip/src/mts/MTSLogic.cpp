...
namespace cmd
{   
    bool Stream::append(Object *object, unsigned int size)
    {
        object->__to_msg__record__(cmd::ADD, this);
        return true;
    }
    bool Stream::pick(Object *object, unsigned int size)
    {
        object->__to_msg__record__(cmd::GET, this);
        return true;
    } 
